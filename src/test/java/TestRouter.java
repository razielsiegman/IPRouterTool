...
public class TestRouter
{
    ...
    @Test
    public void port4Test()
    {
        this.router = new IPRouter(8,4);
        try {
            router.loadRoutes(System.getProperty("user.dir") + File.separator + "src" + File.separator + "test" + File.separator + "java" + File.separator + "routes3.txt");
        }
        catch (FileNotFoundException e) {
            throw new RuntimeException("Bad routes file name. Tests aborted");
        }
    ...
    public void routes2Test(){
        ...
        BitVectorTrie trie = router.trie;
        assertTrue(trie.isRoutable(address1));
        assertTrue(trie.isRoutable(address2));
        assertTrue(trie.isRoutable(address3));
        assertTrue(trie.isRoutable(address4));
        assertTrue(trie.isRoutable(address5));
        assertTrue(trie.isRoutable(address6));
        assertTrue(trie.isRoutable(address7));
        assertTrue(trie.isRoutable(address8));
        assertTrue(trie.isRoutable(address9));
        assertTrue(trie.isRoutable(address10));
        assertTrue(trie.isRoutable(address11));
        router.deleteRule("85.0.0.0/8");
        router.deleteRule("85.85.0.0/15");
        assertFalse(trie.isRoutable(address10));
        assertFalse(trie.isRoutable(address11));
        router.addRule("85.85.0.0/15", 1);
        assertFalse(trie.isRoutable(address10));
        assertTrue(trie.isRoutable(address11));
    }
